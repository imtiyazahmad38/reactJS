...
const useRegForm = (initialValues,regvalidate) => {
	...
	const HandleSubmit = (event) => {
		...
		if(noErrors){
            ...
            let request = {"request":{"type":"registration","devicetype":"I"},"requestinfo":{"firstName":inputs.firstName,"lastName":inputs.lastName,"email":inputs.email,"password":inputs.password,"c_password":inputs.cpassword,"phoneNumber":inputs.phoneNumber,"isMobileVerified":"1"}}
